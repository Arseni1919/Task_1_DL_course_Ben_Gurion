...
params['Prepare']['spatial_cell_size'] = (10, 10)
params['Prepare']['orientations'] = 20  # SplitData[‘Train’][‘Data’], Params[‘Prepare’]
...
def plot_graph(name):
    ...
    with open(name, 'rb') as fileObject:
        ...
        plt.title('Validation Accuracy vs %s - Linear SVM Model' % name)
        plt.legend()
        plt.show()
...
if __name__ == '__main__':
    ...
    # x_labels = [ 50, 75, 100, 115, 125, 135, 150, 175, 200]  # S
    ...
    # x_i_labels = [0.001, 0.01, 0.1, 1, 10, 100, 1000]  # gamma
...
# 1 / 99  Values  50  and  9 : get accuracy of  0.665
# 2 / 99  Values  50  and  10 : get accuracy of  0.66
# 3 / 99  Values  50  and  11 : get accuracy of  0.68
# 4 / 99  Values  50  and  20 : get accuracy of  0.67
# 5 / 99  Values  50  and  30 : get accuracy of  0.65
# 6 / 99  Values  50  and  40 : get accuracy of  0.645
# 7 / 99  Values  50  and  50 : get accuracy of  0.665
# 8 / 99  Values  50  and  60 : get accuracy of  0.64
# 9 / 99  Values  50  and  70 : get accuracy of  0.625
# 10 / 99  Values  50  and  80 : get accuracy of  0.62
# 11 / 99  Values  50  and  90 : get accuracy of  0.63
# 12 / 99  Values  75  and  9 : get accuracy of  0.7050000000000001
# 13 / 99  Values  75  and  10 : get accuracy of  0.72
# 14 / 99  Values  75  and  11 : get accuracy of  0.725
# 15 / 99  Values  75  and  20 : get accuracy of  0.685
# 16 / 99  Values  75  and  30 : get accuracy of  0.6849999999999999
# 17 / 99  Values  75  and  40 : get accuracy of  0.67
# 18 / 99  Values  75  and  50 : get accuracy of  0.66
# 19 / 99  Values  75  and  60 : get accuracy of  0.665
# 20 / 99  Values  75  and  70 : get accuracy of  0.65
# 21 / 99  Values  75  and  80 : get accuracy of  0.66
# 22 / 99  Values  75  and  90 : get accuracy of  0.645
# 23 / 99  Values  100  and  9 : get accuracy of  0.615
# 24 / 99  Values  100  and  10 : get accuracy of  0.605
# 25 / 99  Values  100  and  11 : get accuracy of  0.625
# 26 / 99  Values  100  and  20 : get accuracy of  0.6050000000000001
# 27 / 99  Values  100  and  30 : get accuracy of  0.61
# 28 / 99  Values  100  and  40 : get accuracy of  0.605
# 29 / 99  Values  100  and  50 : get accuracy of  0.615
# 30 / 99  Values  100  and  60 : get accuracy of  0.605
# 31 / 99  Values  100  and  70 : get accuracy of  0.615
# 32 / 99  Values  100  and  80 : get accuracy of  0.61
# 33 / 99  Values  100  and  90 : get accuracy of  0.62
# 34 / 99  Values  115  and  9 : get accuracy of  0.54
# 35 / 99  Values  115  and  10 : get accuracy of  0.54
# 36 / 99  Values  115  and  11 : get accuracy of  0.54
# 37 / 99  Values  115  and  20 : get accuracy of  0.555
# 38 / 99  Values  115  and  30 : get accuracy of  0.55
# 39 / 99  Values  115  and  40 : get accuracy of  0.555
# 40 / 99  Values  115  and  50 : get accuracy of  0.5750000000000001
# 41 / 99  Values  115  and  60 : get accuracy of  0.5800000000000001
# 42 / 99  Values  115  and  70 : get accuracy of  0.5900000000000001
# 43 / 99  Values  115  and  80 : get accuracy of  0.5900000000000001
# 44 / 99  Values  115  and  90 : get accuracy of  0.6050000000000001
# 45 / 99  Values  125  and  9 : get accuracy of  0.5
# 46 / 99  Values  125  and  10 : get accuracy of  0.505
# 47 / 99  Values  125  and  11 : get accuracy of  0.5
# 48 / 99  Values  125  and  20 : get accuracy of  0.52
# 49 / 99  Values  125  and  30 : get accuracy of  0.525
# 50 / 99  Values  125  and  40 : get accuracy of  0.535
# 51 / 99  Values  125  and  50 : get accuracy of  0.545
# 52 / 99  Values  125  and  60 : get accuracy of  0.56
# 53 / 99  Values  125  and  70 : get accuracy of  0.5700000000000001
# 54 / 99  Values  125  and  80 : get accuracy of  0.5650000000000001
# 55 / 99  Values  125  and  90 : get accuracy of  0.5700000000000001
# 56 / 99  Values  135  and  9 : get accuracy of  0.455
# 57 / 99  Values  135  and  10 : get accuracy of  0.44
# 58 / 99  Values  135  and  11 : get accuracy of  0.455
# 59 / 99  Values  135  and  20 : get accuracy of  0.47000000000000003
# 60 / 99  Values  135  and  30 : get accuracy of  0.48500000000000004
# 61 / 99  Values  135  and  40 : get accuracy of  0.51
# 62 / 99  Values  135  and  50 : get accuracy of  0.505
# 63 / 99  Values  135  and  60 : get accuracy of  0.515
# 64 / 99  Values  135  and  70 : get accuracy of  0.525
# 65 / 99  Values  135  and  80 : get accuracy of  0.54
# 66 / 99  Values  135  and  90 : get accuracy of  0.535
# 67 / 99  Values  150  and  9 : get accuracy of  0.325
# 68 / 99  Values  150  and  10 : get accuracy of  0.325
# 69 / 99  Values  150  and  11 : get accuracy of  0.325
# 70 / 99  Values  150  and  20 : get accuracy of  0.35000000000000003
# 71 / 99  Values  150  and  30 : get accuracy of  0.36
# 72 / 99  Values  150  and  40 : get accuracy of  0.435
# 73 / 99  Values  150  and  50 : get accuracy of  0.45
# 74 / 99  Values  150  and  60 : get accuracy of  0.48000000000000004
# 75 / 99  Values  150  and  70 : get accuracy of  0.5
# 76 / 99  Values  150  and  80 : get accuracy of  0.505
# 77 / 99  Values  150  and  90 : get accuracy of  0.515
# 78 / 99  Values  175  and  9 : get accuracy of  0.28500000000000003
# 79 / 99  Values  175  and  10 : get accuracy of  0.31
# 80 / 99  Values  175  and  11 : get accuracy of  0.29500000000000004
# 81 / 99  Values  175  and  20 : get accuracy of  0.32
# 82 / 99  Values  175  and  30 : get accuracy of  0.31
# 83 / 99  Values  175  and  40 : get accuracy of  0.33
# 84 / 99  Values  175  and  50 : get accuracy of  0.355
# 85 / 99  Values  175  and  60 : get accuracy of  0.375
# 86 / 99  Values  175  and  70 : get accuracy of  0.415
